        ...
        <div class="container-fluid px-5">
            <div class="row">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <img class="img-fluid toogleimg" src="assets/images/toggle.png" alt="image" />
                    </button>
                    <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo03">

                        <ul class="navbar-nav mobileNavBar">
                        <li class="nav-item mobilelogo">
                                <a class="nav-link" href="index.php"><img class="img-fluid" src="assets/images/m-logo.png" alt="Mobile Logo" /></a>
                            </li>
                            <li class="nav-item">
